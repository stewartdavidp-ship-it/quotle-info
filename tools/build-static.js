...
${STATES.map(stateRow).join('\n')}
        ...
        <section aria-labelledby="rights-h">
            ...
            <p class="big">&ldquo;Who really said it?&rdquo; and &ldquo;Is it free to reuse?&rdquo; are different claims, and we keep them apart.</p>
            <p class="note"><strong>Attribution</strong> is about the historical record — who wrote or said the words. <strong>Rights</strong> are about copyright — whether you can reuse them freely. A quote can be firmly attributed and still under copyright, or in the public domain and still misattributed. Where a page asserts public-domain status, that is a separate, stated claim.</p>
        </section>
