...
const privacyBody = `        <section aria-labelledby="p-sum">
        ...
        <section aria-labelledby="p-collect">
            ...
            <p>The report and nomination forms have an <strong>optional</strong> email field. It is used for one thing: <strong>replying to you once about that report</strong> &mdash; what we found, or what we decided. It is stored alongside the report, never sold, never shared, never added to a mailing list, and never used to contact you about anything else. Leave it blank and the report still counts; you just won&rsquo;t hear back.</p>
        </section>
