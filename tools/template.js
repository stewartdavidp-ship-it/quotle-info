        ...
        (function(){
            ...
            f.addEventListener('submit',function(e){ e.preventDefault();
                ...
                token(function(t){ if(!t){ btn.disabled=false; show('Verification failed \\u2014 please try again.',true); return; }
                    fetch(API+'/submit-source',{method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify({slug:slug,url:url,stance:stance,reason:reason,note:note,token:t})})
