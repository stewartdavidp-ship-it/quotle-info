...
function renderSourceSubmit(q) {
  if (!COMMUNITY) return '';
  return `
        <!-- ============ ADD A SOURCE (reader evidence, not an edit) ============ -->
        <details class="src-add">
            <summary>Know a source that supports or challenges this? <span class="src-add-cue">Add a link &rarr;</span></summary>
            <form class="src-add-form" id="srcForm" data-slug="${esc(q.quoteSlug)}">
                <p class="src-add-lede">Paste a URL and we&rsquo;ll check it. This doesn&rsquo;t change the page &mdash; it goes to our review queue, and if it holds up we update the record with a citation.</p>
