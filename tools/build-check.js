    ...
    (function(){
        ...
        function narrowForm(prompt){
            return '<div class="narrow"><p class="r-lbl">'+(prompt||'Know who said it, or where it\\u2019s from? Narrow it down')+'</p>'+
                ...
                '<input class="narrow-in" id="n-author" type="text" placeholder="Author (e.g. Oscar Wilde)" value="'+esc(hintAuthor)+'">'+
                '<input class="narrow-in" id="n-source" type="text" placeholder="Film, book, or speech" value="'+esc(hintSource)+'">'+
