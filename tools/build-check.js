...
const inner = `    <nav class="breadcrumb" aria-label="Breadcrumb"><a href="/">Home</a><span class="sep">›</span>Check a quote</nav>
    <main>
        <div class="hero">
            ...
            <p class="lede">About to drop a quote on a slide? Paste it below. We&rsquo;ll tell you if it&rsquo;s <b>real</b>, <b>who really said it</b>, and whether it&rsquo;s <b>cleared to reuse</b> &mdash; checked against primary sources, not guessed by an AI.</p>
        </div>
        <div class="check-box">
    ...
    (function(){
        ...
        function creditBlock(hit){
            ...
            return '<div class="r-credit-wrap"><p class="r-lbl">Paste-ready credit</p><div class="r-credit" id="rcredit">\\u201c'+esc(hit.q)+'\\u201d '+esc(hit.credit)+'</div>'+
                ...
                '<a class="r-btn" href="'+esc(hit.u)+'">See the proof &amp; image direction \\u2192</a></div></div>';
        }
