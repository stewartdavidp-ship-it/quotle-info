...
- **Corpus: 1078** quotes + 27 songs. **Target: 2000.**
- **Next wave number: r24.** (Waves r6–r23 shipped via this pipeline. Numbering is just a label for batch/scratch files.)
- Harvest backlog: `data/harvest-queue.json` (committed) — 431 queued.
